...
export async function runPendingFindMyPhotosMatching() {
  const pendingExpression = `resource_type:image AND folder:${SELFIE_FOLDER} AND tags=${REQUEST_TAG_PENDING} AND NOT tags=${REQUEST_TAG_READY} AND NOT tags=${REQUEST_TAG_NO_MATCH}`;
